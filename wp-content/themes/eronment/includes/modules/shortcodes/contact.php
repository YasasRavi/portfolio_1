<!--In Touch Section-->
<section class="<?php echo esc_attr(wp_kses_post($class));?> in-touch-section">
	<div class="auto-container">
		<!--Title Box-->
		<div class="title-box">
			<h2><?php echo wp_kses_post($title);?></h2>
			<div class="title"><?php echo wp_kses_post($text);?></div>
		</div>
			...
			<div class="info-column col-md-5 col-sm-12 col-xs-12">
				<div class="inner-column">
					...
					<ul class="list-style-two">
						...
						<li><span class="icon <?php echo esc_attr($item->icon); ?>"></span><strong><?php echo wp_kses_post($item->title); ?></strong><?php echo wp_kses_post($item->text); ?></li>
