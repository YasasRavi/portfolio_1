...
<section class="<?php echo esc_attr(wp_kses_post($class));?> services-page-section">
	<div class="auto-container">
		...
		<div class="row clearfix">
			...
			<!--Service Block Three-->
			<div class="service-block-three col-md-<?php echo esc_attr(wp_kses_post($column));?> col-lg-3 col-sm-6 col-xs-12">
				<div class="inner-box">
					<div class="icon-box">
