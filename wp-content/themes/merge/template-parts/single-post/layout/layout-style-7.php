...
$column_sidebar_class = 'col-lg-4 order-lg-1';
$column_content_class = is_active_sidebar( 'blog_sidebar' ) ? 'col-lg-8 order-lg-2' : 'col-lg-8 offset-lg-2';
...
<main class="vlt-main">
	...
	<?php
		...
		if ( has_post_thumbnail() ) {
			...
			echo '<div class="vlt-navbar-offset">';

			get_template_part( 'template-parts/single-post/media/media', 'style-3' );
