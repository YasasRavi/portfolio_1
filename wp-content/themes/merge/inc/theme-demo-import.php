 ...
 * Demo import
 */
if ( ! function_exists( 'merge_demo_import_files' ) ) {
	function merge_demo_import_files() {
		return array(
			array(
				'import_file_name' => esc_html__( 'Demo Import', 'merge' ),
				'local_import_file' => MERGE_REQUIRE_DIRECTORY . 'inc/demo/demo-content.xml',
				'local_import_widget_file' => MERGE_REQUIRE_DIRECTORY . 'inc/demo/widgets.wie',
				'local_import_customizer_file' => MERGE_REQUIRE_DIRECTORY . 'inc/demo/customizer.dat'
			),
		);
	}
}
add_filter( 'pt-ocdi/import_files', 'merge_demo_import_files' );
 ...
 */
if ( ! function_exists( 'merge_after_import_setup' ) ) {
	function merge_after_import_setup() {
		...
		if ( ! $cpt_support ) {
			$cpt_support = [ 'page', 'post', 'portfolio', 'fullpage-slide', 'content-slide' ]; // create array of our default supported post types
...
add_action( 'pt-ocdi/after_import', 'merge_after_import_setup' );