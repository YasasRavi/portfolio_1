...
class vlthemes_widget_popular_posts extends WP_Widget {
	...
	public function __construct() {
		$widget_details = array(
			'classname' => 'vlt_widget_popular_posts',
			'description' => esc_html__( 'Shows popular posts.', 'vlthemes' )
		);
	...
	public function widget( $args, $instance ) {
		...
		$popular_posts_layout = get_field( 'popular_posts_layout', 'widget_' . $widget_id );
