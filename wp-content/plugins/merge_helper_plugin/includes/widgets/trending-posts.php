...
class vlthemes_widget_trending_posts extends WP_Widget {

	public function __construct() {
		$widget_details = array(
			'classname' => 'vlt_widget_trending_posts',
			'description' => esc_html__( 'Shows trending posts.', 'vlthemes' )
		);
		parent::__construct( 'vlthemes_widget_trending_posts', esc_html__( 'VLThemes: Trending Posts', 'vlthemes' ), $widget_details );
	}
