...
if ( ! class_exists( 'VLThemesAddCustomFonts' ) ) {
	class VLThemesAddCustomFonts {
		...
		public function custom_fonts( $fonts ) {
			...
			$custom_fonts = get_option( 'vlthemes-custom-fonts' ) ? get_option( 'vlthemes-custom-fonts' ) : [];
		...
		public function typekit_fonts( $fonts ) {
			...
			$typekit_fonts = get_option( 'custom-typekit-fonts' ) ? get_option( 'custom-typekit-fonts' )[ 'custom-typekit-font-details' ] : [];
