...
class Widget_VLThemes_Counter_Up_Small extends Widget_Base {

	public function get_name() {
		return 'vlt-counter-up-small';
	}

	public function get_title() {
		return esc_html__( 'Counter Up (Small)', 'vlthemes' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'section_' . $first_level++, [
				'label' => esc_html__( 'Counter Up (Small)', 'vlthemes' ),
			]
		);
		...
		$this->add_control(
			'number_color', [
				...
				'selectors' => [
					'{{WRAPPER}} .vlt-counter-up-small__number' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			Group_Control_Typography::get_type(), [
				...
				'selector' => '{{WRAPPER}} .vlt-counter-up-small__number',
			]
		);
		...
		$this->add_control(
			'prefix_color', [
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .vlt-counter-up-small__number .prefix' => 'color: {{VALUE}}',
				]
			]
		);
		...
		$this->add_control(
			'suffix_color', [
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .vlt-counter-up-small__number .suffix' => 'color: {{VALUE}}',
				]
			]
		);
		...
		$this->add_control(
			'number_width', [
				...
				'selectors' => [
					'{{WRAPPER}} .vlt-counter-up-small__number' => 'min-width: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			'number_padding', [
				...
				'selectors' => [
					'{{WRAPPER}} .vlt-counter-up-small__number' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				]
			]
		);
		...
		$this->add_responsive_control(
			'number_margin', [
				...
				'size_units' => [ 'px', 'em', 'rem', '%' ],
				'selectors' => [
					'{{WRAPPER}} .vlt-counter-up-small__number' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				]
			]
		);
		...
		$this->add_control(
			'title_color', [
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .vlt-counter-up-small__title' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			Group_Control_Typography::get_type(), [
				...
				'selector' => '{{WRAPPER}} .vlt-counter-up-small__title',
			]
		);
		...
		$this->add_control(
			'title_indent', [
				...
				'selectors' => [
					'{{WRAPPER}} .vlt-counter-up-small' => 'gap: {{SIZE}}{{UNIT}};',
				]
			]
		);
	...
	protected function render() {
		...
		$this->add_render_attribute( 'counter-up', [
			'class' => 'vlt-counter-up-small',
		...
		$this->add_render_attribute( 'title', 'class', 'vlt-counter-up-small__title' );
		...
		<div <?php echo $this->get_render_attribute_string( 'counter-up' ); ?>>
			...
			<div class="vlt-counter-up-small__number">
